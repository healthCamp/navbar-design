...
export default function Header() {
  ...
  return (
    <>
      ...
      <div
        id="page-container"
        className="mx-auto flex min-h-dvh w-full min-w-[320px] flex-col dark:bg-gray-900 dark:text-gray-100 bg-gray-100 "
      >
        {/* Page Header */}
        <header
          id="page-header"
          ...
          <div className="container mx-auto px-4 lg:px-8 xl:max-w-7xl">
            <div className="flex justify-between py-4">
              ...
              <div className="flex items-center space-x-2 lg:space-x-5">
                ...
                <nav className="hidden items-center space-x-2 lg:flex">
                  <Link
                    href="#"
                    className="group flex items-center space-x-2 rounded-lg border border-teal-100 bg-teal-50 px-3 py-2 text-sm font-medium text-teal-600 dark:border-transparent dark:bg-gray-700 dark:text-white"
                  >
                    <svg
                  ...
                  <Link
                    href="#"
                    className="group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium text-gray-800 hover:bg-teal-50 hover:text-teal-600 active:border-teal-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600"
                  >
                    <svg
            ...
            <div className={`lg:hidden ${mobileNavOpen ? "" : "hidden"}`}>
              <nav className="flex flex-col space-y-2 border-t py-4 dark:border-gray-700">
                <Link
                  href="#"
                  className="group flex items-center space-x-2 rounded-lg border border-teal-50 bg-teal-50 px-3 py-2 text-sm font-semibold text-teal-600 dark:border-transparent dark:bg-gray-700/75 dark:text-white"
                >
                  <svg
                    className="hi-mini hi-home inline-block size-5"
                    xmlns="http://www.w3.org/2000/svg"
